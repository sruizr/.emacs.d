...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (try counsel pyenv-mode spaceline color-theme-sanityinc-tomorrow helm-projectile hydra magit use-package transpose-frame projectile org-bullets hydra elpy dash)))
